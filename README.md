...
다음은 libuv의 스레드 풀을 사용하는 일부 I/O 작업입니다.
...
-> [Change default thread pool size from fixed 4 to number of logical cores #1578](https://github.com/joyent/libuv/issues/1578)
...
## Running test in pm2 cluster mode (2 instances)
